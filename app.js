(() => {
  ...
  const primaryEmail = safeEmail(config.primaryEmail) || 'pavanmahadev9901@gmail.com';
  ...
  for (const [type, value, domains] of [
    ['linkedin', config.linkedinUrl, ['linkedin.com']],
    ['instagram', config.instagramUrl, ['instagram.com']],
    ['github', config.githubUrl, ['github.com']],
    ['company', config.companyUrl, ['greennetspark.in']]
  ]) {
